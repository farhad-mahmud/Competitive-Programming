...
// string npos points to the end of the max string.. if its true..
...
// string npos points to the end of the max string.. if its true..
// then that char is not there before..

cout << endl; 

cout << "my secret key is " << endl; 

for(char c : uniqueKeyText){
	  cout << c << ' ' ;
}
